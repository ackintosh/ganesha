...
PHP client generated by Swagger Codegen (v2.3~) is using Guzzle as HTTP client and as we mentioned as [Ganesha :heart: Guzzle](https://github.com/ackintosh/ganesha#ganesha-heart-guzzle), Guzzle Middleware powered by Ganesha is ready. So it is possible to integrate Ganesha and the PHP client in a smart way as below.
...
// Just pass the client to the constructor of API class
